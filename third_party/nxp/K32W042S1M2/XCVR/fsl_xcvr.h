...
#define XCVR_802_15_4_ENABLED 1
#endif
...
#define TSM_TIMING14init  (0x6d356864UL) /* (sy_pd_cycle_slip_ld_ft_en) */
...
#define TSM_TIMING13init  (0x18004c00UL) /* (pll_loop_is_open) */
#define TSM_TIMING14init  (0x69316863UL) /* (sy_pd_cycle_slip_ld_ft_en) */
...
#if RADIO_IS_GEN_3P0
#define TX_RX_ON_DELinit  (0x00008486UL) /*  */
#else /* RADIO_IS_GEN_3P0 */
